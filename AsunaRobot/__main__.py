...
InlineKeyboardButton(
            text="🗨️ Event", url="https://telegram.dog/dhinklasoon"
        ),

    ],
    [
        InlineKeyboardButton(
                    text="💬 Support Chat", url="https://telegram.dog/animeweebs3"
        ),
    ],
]
...
HELP_STRINGS = """
`Hi.. I'm` [Erza_Robot 🛠️](https://telegra.ph/file/27af05fdd5fc1f1517bc7.jpg) 
`Click on the buttons below to get documentation about specific modules..`"""


ASUNA_IMG = "https://telegra.ph/file/27af05fdd5fc1f1517bc7.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @The_Ghost_Hunter or @AsunaRobotSupport \
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..👸 I'm *ERZA
                 \nHere is the [Source Code](https://github.com/sadhanhori/Erza_Robot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
